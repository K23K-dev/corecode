// Original file: runner/proto/grpc/health/v1/health.proto
...
export interface HealthClient extends grpc.Client {
   ...
   */
  List(
    argument: _grpc_health_v1_HealthListRequest,
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: grpc.requestCallback<_grpc_health_v1_HealthListResponse__Output>,
  ): grpc.ClientUnaryCall;
  List(
    argument: _grpc_health_v1_HealthListRequest,
    metadata: grpc.Metadata,
  ...
  Watch(
    ...
    metadata: grpc.Metadata,
    options?: grpc.CallOptions,
  ): grpc.ClientReadableStream<_grpc_health_v1_HealthCheckResponse__Output>;
  Watch(
    argument: _grpc_health_v1_HealthCheckRequest,
    options?: grpc.CallOptions,
  ): grpc.ClientReadableStream<_grpc_health_v1_HealthCheckResponse__Output>;

...
import type { ProblemTab } from './ProblemPanel';
import Results, { SubmissionCelebration, SubmissionConfetti, type Execution } from './Results';
...
export default function PracticeWorkspace({
  ...
  const { catalog, client } = usePractice();
          ...
          <div className="ide-navigation">
            ...
            <div className="exercise-navigation">
              <button
                ...
                onClick={() => selectExercise(exercises[currentIndex - 1])}
              >
                <ChevronLeft size={17} />
              </button>
              <button
                ...
                disabled={currentIndex < 0 || currentIndex >= exercises.length - 1}
                onClick={() => selectExercise(exercises[currentIndex + 1])}
              >
